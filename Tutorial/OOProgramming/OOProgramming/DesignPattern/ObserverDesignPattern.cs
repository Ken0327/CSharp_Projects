...
namespace OOProgramming.DesignPattern
{
    class ObserverDesignPattern
    {
        ...
        // ArrivalsMonitor is a base class that displays baggage claim information. The information is displayed alphabetically, by the name of the originating city.
